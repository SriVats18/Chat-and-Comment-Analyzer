      ...
      <div id='contact' className='bg-[url("../images/contactbg.jpg")] w-full h-lvh bg-cover bg-no-repeat  text-white'>
        ...
        <div className="font-averia md:w-1/2 h-auto rounded-2xl bg-slate-100 shadow-lg shadow-red-500/50 flex flex-col px-16 py-10 gap-1 mx-auto md:mt-5 mt-16">
                ...
                <input type="hidden" name="access_key" value="3899889e-9286-40bb-9157-592be704a827"></input>
                    <input className="px-2 py-4 border-b-[2.5px] border-slate-200 bg-transparent text-lg outline-none text-black" name="name" placeholder="Name" type="text" required/>
                    <input className="px-2 py-4 border-b-[2.5px] border-slate-200 bg-transparent text-lg outline-none text-black" name="email" placeholder="Email" type="text" required/>
                    <input className="px-2 py-4 border-b-[2.5px] border-slate-200 bg-transparent text-lg outline-none text-black" name="phone" placeholder="Phone" type="text"/>
                    <textarea className="px-2 py-4 border-b-[2.5px] border-slate-200 bg-transparent text-lg outline-none text-black" name="message" id="" cols={30} rows={4} placeholder="Message "></textarea>
